...
<div class="flex w-full gap-5 flex-wrap md:flex-nowrap">
    <div class="flex flex-col gap-3 md:w-1/2 bg-slate-800 p-5 rounded w-full order-2 md:order-1"
        role="list"
        ...
        <div class="flex flex-col gap-3 flex-wrap w-full">
    ...
    <div class="flex flex-col gap-3 md:w-1/2 bg-slate-800 p-5 rounded w-full order-1 md:order-2"
        role="list"
